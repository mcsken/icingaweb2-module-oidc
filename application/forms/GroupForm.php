...
class GroupForm extends CompatForm
{
     ...
     *
     * @return \Icinga\Module\Oidc\Forms\GroupForm
     */
    ...
    /**
     * Create a new form instance with the given group id
     *
     * @param $id
     *
     * @return \Icinga\Module\Oidc\Forms\GroupForm
    ...
    public function getSubmitButtonLabel(): string
    {
        ...
        return $this->id === null ? $this->translate('Create Group') : $this->translate('Update Group');
    }
    protected function assemble()
    {

        $columns = (new Group())->getColumnDefinitions();
        ...
        if ($this->id !== null) {
            ...
            $removeButton = $this->createElement('submit', 'remove', [
                'label'          => $this->translate('Remove Group'),
                'class'          => 'btn-remove',
                'formnovalidate' => true
            ]);
    ...
    public function onSuccess()
    {
        ...
        if ($this->id === null) {
            ...
            $model = Group::on(Database::get())->filter(Filter::equal('id', $this->id))->first();
