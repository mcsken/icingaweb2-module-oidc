...
use Icinga\Module\Oidc\GroupTable;
...
class GroupsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        if ($this->hasPermission('oidc/group/modify')) {
            $this->addControl(
                (new ButtonLink(
                    $this->translate('New Group'),
                    Url::fromPath('oidc/group/new'),
                    'plus'
                ))->openInModal()
            );
        }

        $this->addTitleTab($this->translate('Groups'));
        ...
        $this->addContent((new GroupTable())->setData($models));
    ...
    {
        $editor = $this->createSearchEditor(Group::on(Database::get()), [
