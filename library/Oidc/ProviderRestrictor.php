    ...
    public function applyRestrictions(Query $query)
    {
        ...
        foreach ($queries as $query) {
            ...
            foreach ($this->getAuth()->getUser()->getRoles() as $role) {
                ...
                if (($restriction = $role->getRestrictions('oidc/filter/providers'))) {
                    $roleFilter->add($this->parseRestriction($restriction, 'oidc/filter/providers'));
                }
